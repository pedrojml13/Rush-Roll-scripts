...
public class PlayerDataManager : MonoBehaviour
{
    ...
    public void saveLanguaje(int lang)
    {
    ...
    public void LoadLanguaje(System.Action<int> callback)
    {
        string uid = AuthManager.currentUser.UserId;
        DocumentReference docRef = db.Collection("users").Document(uid);
    ...
    public void SaveLevel(LevelData level)
    {
        ...
        // Guardamos el nivel bajo el campo "levels.{levelIndex}" usando Merge
        var data = new Dictionary<string, object>
        {
            { $"levels.{level.levelIndex}", levelData }
        };
